...
<link href="${pageContext.request.contextPath }/admin/css/healthmatch.css"
	rel="stylesheet" type="text/css">	
...
<body>
	...
	<div class="p3">
       <img src="${pageContext.request.contextPath }/admin/img/strawberry3.jpg" width="1300" height="250px" />
	</div>
	<div class="p4">
	      <img src="${pageContext.request.contextPath }/admin/img/grape.png">
	</div>
	<div class="p5">
		<table>
			<tr>
				<td><img src="${pageContext.request.contextPath }/admin/img/cherry1.png"/></td>
	       		<td><img src="${pageContext.request.contextPath }/admin/img/strawberry4.png"/></td>
			</tr>
			<tr>
				<td><img src="${pageContext.request.contextPath }/admin/img/apple2.png"/></td>
				<td><img src="${pageContext.request.contextPath }/admin/img/cucumber1.png"/></td>
			</tr>
	   </table> 
  </div>
  <div class="p6">
      <table>
        <tr>
			<td>
				<img src="${pageContext.request.contextPath }/admin/img/caij1.png"/>
			</td>
			<td>
				<img src="${pageContext.request.contextPath }/admin/img/shulb1.png"/>
			</td>
			<td>
				<img src="${pageContext.request.contextPath }/admin/img/hcai1.png">
			</td>
        </tr>
		<tr>
			<td><img src="${pageContext.request.contextPath }/admin/img/tomato2.png"></td>
			<td><img src="${pageContext.request.contextPath }/admin/img/tomato1.png"></td>
			<td><img src="${pageContext.request.contextPath }/admin/img/caij2.png"></td>
		</tr>
		<tr>
			<td><img src="${pageContext.request.contextPath }/admin/img/denlon1.png"></td>
